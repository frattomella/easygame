...
| E-13 | Rimborsi e storni | `DONE` | Il rimborso **si avvia da EasyGame**: un rimborso cita un incasso e non una rata (una rata pagata con 50 + 80 ha due residui rimborsabili distinti), la risposta HTTP non e il registro, e finche il webhook non conferma la riga dice «in elaborazione». Permessi: proprietario e gestore. 79 test, compreso il doppio evento sullo stesso rimborso e la doppia richiesta sullo stesso incasso ([ADR-0065](18-decision-log.md#adr-0065--il-rimborso-si-avvia-da-easygame-a-scriverlo-nel-registro-resta-levento-firmato)) |
