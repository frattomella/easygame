...
| E-13 | Rimborsi e storni | `DONE` | Un rimborso e un **movimento che conta**, distinto dallo storno: 130 incassati − 30 rimborsati = rata PARZIALE con residuo 30. La commissione restituita e proporzionale a quella trattenuta, non ricalcolata su oggi. **Giro reale eseguito il 2026-08-27** nella Sandbox Cedi Soft, questa volta con il rimborso avviato **da EasyGame**: 130 EUR incassati con carta, −30 (netto 100, residuo 30, PARZIALMENTE PAGATA, application fee restituita 30 centesimi), −100 (rata IN ATTESA, fee 1,00 EUR), movimento originale preservato, rimborsi append-only, doppio clic = due POST e un solo `re_…`. Il collaudo ha trovato **sei difetti**, tutti corretti e coperti da regressione: il checkout che non partiva mai, la CTA accesa senza abbonamento, il ritorno dal pagamento che perdeva il club, la commissione cancellata dalla doppia normalizzazione, l'importo digitato che si riscriveva da solo, il netto che ignorava i rimborsi precedenti ([ADR-0065](18-decision-log.md#adr-0065--il-rimborso-si-avvia-da-easygame-a-scriverlo-nel-registro-resta-levento-firmato)) | 1.746 test, piu le prove a runtime nel registro incassi e nel cruscotto Stripe | Si |
