...
| Appuntamenti su slot | COMPLETE | Dal dominio 5E. **PP-02 §K**: il club puo dire **se** riceve richieste online — esisteva solo `active` sulla singola fascia, e chi voleva chiuderle doveva spegnerle a una a una — e **per cosa**: un elenco di motivi con la propria durata, ognuno prenotabile o riservato al desk. La famiglia sceglie fra quelli invece di scrivere un testo libero, e con le richieste chiuse il modulo non compare affatto. Un club che non ha configurato niente continua a ricevere, e uno senza motivi non vincola il motivo (stessa regola di W6-D03) |
