...
| Il legame vale senza tessera di club | COMPLETE | **PP-02 §A** ([ADR-0114](18-decision-log.md#adr-0114--il-legame-di-un-tutore-non-e-la-sua-tessera-il-suo-indirizzo-non-e-un-legame-che-apre-da-solo)). Un tutore collegato ma senza riga in `organization_users` non trovava **nessun** figlio: il vaglio del legame girava su un insieme di candidati scelto dalle tessere. L'indirizzo di contatto resta invece un legame **solo dove il tutore e gia entrato**: lo scrive la segreteria a mano, e un refuso e l'indirizzo verificato di un'altra persona |
...
| Ricevute e documenti di pagamento | COMPLETE | Il gate e il legame. **PP-02 §E** ([ADR-0115](18-decision-log.md#adr-0115--cio-che-la-famiglia-legge-di-un-documento-di-pagamento-e-un-elenco-chiuso)): un elenco solo per ricevute e fatture, con data, numero, causale, importo, **figlio**, stato, «Visualizza» e «Scarica». E soprattutto una **proiezione chiusa**: prima usciva la riga intera — chi ha emesso, chi ha annullato, la classificazione contabile congelata e le chiavi di riconciliazione della cassa del club. Una ricevuta annullata si legge «Annullata» e non sparisce; il motivo dell'annullamento resta del club |
