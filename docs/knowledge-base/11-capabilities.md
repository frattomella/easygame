...
| Accesso di un minore a nome proprio | PARTIAL | Il codice **non decide** la policy: pretende che una persona dichiari la responsabilita genitoriale, e la dichiarazione resta nell'audit (ADR-0116). Le tre domande legali aperte sono nel verbale [45](45-pp-04-athlete.md) e **richiedono validazione umana** |
