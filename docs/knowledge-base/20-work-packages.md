...
| Area allenatore, famiglia, atleta (`/trainer-dashboard`, `/parent-view`, `/athlete-dashboard`, `/pay`, `/iscrizione`, onboarding) | **Chiuso** (2026-09-16, [ADR-0187](18-decision-log.md)) — `AreaShell` unico, `OutsideShell` per l'ambiente 3, contrasto sul cielo nel sistema, marchio CediSoft, scadenza convocazioni in Impostazioni; censimento in `docs/redesign/COMPLETION-PASS.md` (rotte V1: 0, miste: 0) |
| Persone in prova (dominio, presenze, vista «Atleti in prova», conversione) | **Chiuso** (2026-09-16, [ADR-0188](18-decision-log.md)) — migrazione additiva sul solo redesign, 33 prove |
