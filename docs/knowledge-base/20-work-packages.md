...
### WP-47 · Modulistica V2, moduli online e iscrizioni online — `DONE` (2026-08-26)
...
1. **I moduli vivevano in un campo JSON condiviso.** Salvare una risposta
   ...
   `resources.ts`. Vedi [ADR-0036](18-decision-log.md#adr-0036--i-moduli-escono-da-clubsdocument_templates-e-diventano-tre-tabelle).
