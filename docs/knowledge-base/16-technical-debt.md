...
| **W4-R5** | **Lo storno di un rimborso legge male il verso.** `reversePaymentTransaction` blocca il ri-storno e lo storno di uno storno, ma non lo storno di un **rimborso**: la riga risultante e positiva e la prima nota la descrive come «Storno incasso», in uscita, mentre il denaro e tornato dentro. I totali restano giusti — entrambe le gambe sono neutralizzate ovunque — e sbagliata e solo la riga che si legge | Distinguere le due cose richiede una regola nuova nel dominio degli incassi: cosa **e** lo storno di un rimborso, e se non sia piuttosto un secondo incasso. E una decisione di dominio, non una correzione |
