...
const TrainerSidebar = memo(() => {
  ...
  return (
    <aside
      className={`flex h-[100dvh] ${collapsed ? "w-[80px]" : "w-[264px]"} flex-col bg-gradient-to-b from-blue-600 to-blue-800 text-white transition-all duration-300 overflow-hidden relative`}
    >
