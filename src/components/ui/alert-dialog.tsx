...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // Stessa regola della dialog: mai piu alta dello schermo, mai senza
        // margine laterale.
        // Vedi `dialog.tsx`: le classi `slide-*` forniscono la traslazione che
        // centra il riquadro, non sono decorazione.
