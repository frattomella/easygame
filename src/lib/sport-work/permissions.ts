 ...
 *
 * `sport_work.read_own` esiste ed e concesso a chi lavora per il club, ma in
 * V1 **nessuna superficie lo consuma**: non c'e ancora una dashboard
 * personale del collaboratore. Concederlo ora significa che il giorno in cui
 * quella dashboard esistera non si dovra riaprire il modello dei permessi; non
 * significa che oggi un allenatore possa elencare i rapporti del club, perche
 * gli endpoint di elenco richiedono `sport_work.read`, che non ha.
 */
