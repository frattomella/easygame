...
const extraInternalApis: InternalApiDocEntry[] = [
  ...
  },
  {
    ...
    description: "Configurazione SMTP di piattaforma. La password non esce mai.",
    auth: "Platform admin",
    params: "-",
    body: "-",
    response: "Host, porta, sicurezza, mittente, esito dell'ultimo test.",
    mobileNotes: "Solo pannello amministrativo interno.",
    status: "Interna",
  },
  {
    ...
    method: "PUT",
    path: "/api/v1/admin/email",
    description: "Salvataggio SMTP. La password viene cifrata a riposo.",
    auth: "Platform admin",
    params: "-",
    body: "enabled, host, port, securityMode, username, password?, fromEmail, fromName",
    response: "Configurazione pubblica aggiornata.",
    mobileNotes: "Solo pannello amministrativo interno.",
    status: "Interna",
  },
  {
    ...
    auth: "Platform admin",
    params: "-",
    body: "to: destinatario della prova",
    response: "{ sent: true } oppure un codice SMTP_* normalizzato.",
    mobileNotes: "Solo pannello amministrativo interno.",
    status: "Interna",
  },
  {
    ...
    description: "Configurazione IMAP di piattaforma. La password non esce mai.",
    auth: "Platform admin",
    params: "-",
    body: "-",
    response: "Host, porta, sicurezza, username, esito dell'ultimo test.",
    mobileNotes: "Solo pannello amministrativo interno.",
    status: "Interna",
  },
  {
    ...
    path: "/api/v1/admin/imap",
    description:
      "Salvataggio IMAP. Credenziali separate da SMTP, cifrate con un contesto proprio.",
    auth: "Platform admin",
    params: "-",
    body: "enabled, host, port, securityMode, username, password?",
    response: "Configurazione pubblica aggiornata.",
    mobileNotes: "Solo pannello amministrativo interno.",
    status: "Interna",
  },
  {
    ...
    description:
      "Apre la sessione IMAP, esegue LOGIN e chiude. Non legge nessun messaggio.",
    auth: "Platform admin",
    params: "-",
    body: "-",
    response: "{ connected: true } oppure un codice IMAP_* normalizzato.",
    mobileNotes: "Solo pannello amministrativo interno.",
    status: "Interna",
  },
  {
